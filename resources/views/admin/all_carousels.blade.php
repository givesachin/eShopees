...
@section('main-content')
    ...
    <script type="text/javascript" src="{{ URL('public/js/angular/admin/all_carousels_controller.js') }}?v={{ $organization->version }}"></script>

    <div ng-app="eShopees" ng-controller="allCarouselsController">

        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">List of Carousels</h1>
                            ...
                            <table class="table d-table table-sm-stack table-sm-striped mb-0" id="table">
                                ...
                                <tr ng-repeat="t in data">
                                    ...
                                    <td data-title="Preview : " class="align-middle" style="min-width: 150px">
                                        <div>
                                            <img ng-if="!t.path || (t.path && t.path == '')" style="height: 130px; width: 500px; object-fit: contain;"
                                                 src="{{ URL('public/uploads/500x130.png') }}"
                                                 alt="" class="img-fluid">
                                            <img ng-if="t.path && t.path != ''" ng-src="<%t.path%>" style="height: 130px; width: 500px; object-fit: contain;"
                                                 onError="this.src='{{ URL('public/uploads/500x130.png') }}'"
                                                 alt="" class="img-fluid">
                                        </div>
                                    </td>
