...
<script type="text/javascript" src="{{ URL('public/js/angular/admin/profile_controller.js') }}?v={{ $organization->version }}"></script>

<div ng-app="eShopees" ng-controller="profileController">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" ng-model="data.user.email" placeholder="example@example.com">
                                    </div>
                                </div>
                            </div>
